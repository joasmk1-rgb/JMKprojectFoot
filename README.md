...
Ouvre `admin.html`, tape le mot de passe temporaire `tournoi2026` (dans `config.js`, à changer si tu veux), crée ton premier tournoi, ajoute tes équipes, génère le calendrier.
